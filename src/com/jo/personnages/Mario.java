...
public class Mario extends Personnage {
	...
	private boolean saut; // renvoi vrai si mario saute
	private int compteurSaut; // sert à gérer la hauteur et la durée du saut
	...
	@Override
	public Image marche(String nom, int frequence) { // On surcharge la méthode mache dans mario car les conditions d'activation ne sont pas les même que pour les tortues et les champ (xPos est a "-1")
	...
	public boolean contactPiece(Piece piece){
		// Le contact avec une piece ne modifie pas le comportement de Mario
